...
public class intermediate_workout extends AppCompatActivity {
    ...
    Double time = 0.0;
    ImageView imageView;
    String fileName, intermediateWorkouts, username, saveWorkoutName;
    Bitmap bitmap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerText = findViewById(R.id.txt_Timer2);
        activityText = findViewById(R.id.txtView_CurrentActivity2);
        btnStartTimer = findViewById(R.id.btn_Start2);
        btnPauseTimer = findViewById(R.id.btn_Pause2);
        btnNextWorkout = findViewById(R.id.btn_NextActivity2);
        btnNextWorkout.setVisibility(View.INVISIBLE);
        imageView = findViewById(R.id.imageView2);
        workoutName = findViewById(R.id.editTxtSaveWorkoutName2);
        workoutName.setVisibility(View.INVISIBLE);

        String pushUps = "Perform 25 pushups then continue!";
        String sitUps = "Perform 25 situps then continue!";
        String jumpingJacks = "Perform 25 jumping jacks then continue!";
        String squats = "Perform 25 squats then continue!";
        ...
        btnStartTimer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((Button)findViewById(R.id.btn_Start2)).setText("Resume");
            }
        });
        ...
        btnNextWorkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((Button)findViewById(R.id.btn_NextActivity2)).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ...
                        btnNextWorkout.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                squats();
                                ((Button)findViewById(R.id.btn_NextActivity2)).setText("End workout");
                                ((Button)findViewById(R.id.btn_NextActivity2)).setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        ...
                                        pauseTapped();
                                        ((Button)findViewById(R.id.btn_NextActivity2)).setText("Save Workout");
                                        ((Button)findViewById(R.id.btn_NextActivity2)).setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View v) {
                                                ...
                                                if(TextUtils.isEmpty(saveWorkoutName)){
                                                    ...
                                                    intermediateWorkouts = timerText.getText().toString();
                                                    username = ParseUser.getCurrentUser().getUsername();
                                                    updateDataToDatabase(intermediateWorkouts, username, saveWorkoutName);
                                                }
                                            }
                                        });
                                    }
    ...
    private void updateDataToDatabase(String intermediateWorkouts, String username, String workoutName){
        ParseObject interWorkout = new ParseObject("IntermediateWorkouts");

        interWorkout.put("username", username);
        interWorkout.put("intermediateWorkouts", intermediateWorkouts);
        interWorkout.put("workoutName", workoutName);


        interWorkout.saveInBackground(new SaveCallback() {
            @Override
